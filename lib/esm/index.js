...
const a = (e, o, i) => {
  ...
  u = (e) => {
    ...
    return {
      ...
      sections: N,
      isOpen: Q,
      getMenuProps: () => ({ ..._(), className: 'cio-results', 'data-testid': 'cio-results' }),
      getLabelProps: q,
      openMenu: z,
      closeMenu: T,
...
function f(t) {
  const { children: n = h } = t,
    { sections: o, isOpen: i, getMenuProps: r, getItemProps: l } = c(d),
    a =
      o &&
      o.some((e) => {
        var t;
...
function x(e) {
  const { children: t = y } = e,
    { getFormProps: n, getInputProps: o, getLabelProps: i, setQuery: r } = c(d);
...
function b(t) {
  const { children: n } = t;
  return n
    ? e.createElement(m, { ...t }, n)
    : e.createElement(
        'div',
        null,
        e.createElement(m, { ...t }, e.createElement(x, null), e.createElement(f, null))
      );
}
export {
