...
const a = (e, o, i) => {
  ...
  u = (e) => {
    const i = 'What can we help you find today?',
      ...
      })({ apiKey: d, cioJsClient: p }),
      E = !h.length && f,
      P = E ? f : v,
      w = null == P ? void 0 : P.filter((e) => 'autocomplete' === e.type || !e.type),
      S = null == P ? void 0 : P.filter((e) => 'recommendations' === e.type),
      C = a(h, b, w),
      k = ((e, o) => {
        const [i, c] = t({});
        return (
    ...
    null == P ||
      P.forEach((e) => {
        const { identifier: t, data: n } = e,
          o = I[t] || n;
        o && void 0 !== o && N.push({ ...e, data: o });
      });
    const M = [];
    null == N ||
      N.forEach((e) => {
        (null == e ? void 0 : e.data) && M.push(...e.data);
      });
    const F = (({
        setQuery: e,
        items: t,
        ...
        }))({ setQuery: x, onChange: u, items: M, onSubmit: c, cioClient: b, previousQuery: y }),
      {
        isOpen: Q,
        getMenuProps: A,
        getLabelProps: _,
    ...
    return {
      ...
      getItemProps: ({ item: e, index: t = 0, sectionIdentifier: n = 'Products' }) => {
        ...
        })({ activeSections: N, sectionIdentifier: n });
        return {
          ...F.getItemProps({ item: e, index: t + o }),
          className: 'cio-item',
      ...
      getInputProps: () => ({
        ...
        onFocus: () => {
          ...
          e.onFocus && e.onFocus(),
            E && !1 !== m && F.openMenu(),
            null === (t = null == b ? void 0 : b.tracker) || void 0 === t || t.trackInputFocus();
        },
        className: 'cio-input',
      ...
      getFormProps: () => ({
        ...
        onSubmit: (e) => (
          e.preventDefault(),
          c && c({ query: h }),
          null == b || b.tracker.trackSearchSubmit(h, { original_query: h }),
          { query: h }
        ),
        className: 'cio-form',
...
function f(t) {
  const { children: n = h } = t,
    { sections: o, isOpen: i, getMenuProps: r, getItemProps: l } = c(m),
    a =
      o &&
      o.some((e) => {
        var t;
...
const h = ({ sections: t }) =>
  e.createElement(
    e.Fragment,
    null,
    null == t ? void 0 : t.map((t) => e.createElement(g, { section: t, key: t.identifier }))
  );
function x(e) {
  const { children: t = y } = e,
    { getFormProps: n, getInputProps: o, getLabelProps: i, setQuery: r } = c(m);
  return t({ getFormProps: n, getInputProps: o, getLabelProps: i, setQuery: r });
}
const y = ({ getFormProps: t, getInputProps: n, getLabelProps: o, setQuery: i }) => {
  const c = n();
  return e.createElement(
    'form',
    { ...t() },
...
function b(t) {
  ...
  return n
    ...
    : e.createElement(
        'div',
        null,
        e.createElement(d, { ...t }, e.createElement(x, null), e.createElement(f, null))
      );
}
export {
  f as AutocompleteResults,
  b as CioAutocomplete,
  x as SearchInput,
  p as SectionItem,
  g as SectionItemsList,
  u as useCioAutocomplete
};
