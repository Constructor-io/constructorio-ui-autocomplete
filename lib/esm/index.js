...
import c from '@constructor-io/constructorio-client-javascript';
...
const s = (e, o, i) => {
  ...
  d = (e) => {
    const i = 'What can we help you find today?',
      ...
      E = (({ apiKey: e, cioJsClient: o }) => {
        const [i, r] = t(o);
        return (
          n(() => {
            if (e && !o) {
              const t = new c({ apiKey: e, sendTrackingEvents: !0 });
              r(t);
            } else o && r(o);
          }, [e, o]),
          i
        );
      })({ apiKey: p, cioJsClient: g }),
      w = !x.length && h;
    let P = w ? h : f;
    f &&
      !Array.isArray(f) &&
      ...
      h &&
        ...
        (P = []));
    const S = null == P ? void 0 : P.filter((e) => 'autocomplete' === e.type || !e.type),
      C = null == P ? void 0 : P.filter((e) => 'recommendations' === e.type),
      I = s(x, E, S),
      k = ((e, o) => {
        const [i, r] = t({});
        return (
              ...
              (async () => {
                const t = await Promise.all(
                    o.map(({ identifier: t, parameters: n }) =>
                      e.recommendations.getRecommendations(t, n)
                    )
                  ),
                  n = {};
                t.forEach(({ response: e }) => {
                  ...
                  (null == t ? void 0 : t.id) &&
                    (n[t.id] = null == o ? void 0 : o.map((e) => ({ ...e, section: t.id })));
                }),
                  r(n);
              })();
          }, [e]),
    ...
    null == P ||
      P.forEach((e) => {
        const { identifier: t, data: n } = e,
          o = N[t] || n;
        o && void 0 !== o && A.push({ ...e, data: o });
      });
    const F = [];
    null == A ||
      A.forEach((e) => {
        (null == e ? void 0 : e.data) && F.push(...e.data);
      });
    const M = (({
        setQuery: e,
        items: t,
          ...
          onSelectedItemChange({ selectedItem: t }) {
            ...
            t &&
              ...
              (null == t ? void 0 : t.value) &&
                (n && n({ item: t, originalQuery: i }),
                (null === (r = null == t ? void 0 : t.data) || void 0 === r ? void 0 : r.url) ||
                  null == o ||
        ...
        }))({ setQuery: y, onChange: d, items: F, onSubmit: r, cioClient: E, previousQuery: b }),
      { isOpen: Q, getMenuProps: z, getLabelProps: T, openMenu: q, closeMenu: L } = M;
    return {
      query: x,
      sections: A,
      isOpen: Q,
      getMenuProps: () => ({ ...z(), className: 'cio-results', 'data-testid': 'cio-results' }),
      getLabelProps: T,
      openMenu: q,
      closeMenu: L,
      getItemProps: ({ item: e, index: t = 0, sectionIdentifier: n = 'Products' }) => {
        ...
        })({ activeSections: A, sectionIdentifier: n });
        return {
      ...
      getInputProps: () => ({
        ...
        onFocus: () => {
          ...
          e.onFocus && e.onFocus(),
            w && !1 !== m && M.openMenu(),
            null === (t = null == E ? void 0 : E.tracker) || void 0 === t || t.trackInputFocus();
        },
        className: 'cio-input',
      ...
      getFormProps: () => ({
        onSubmit: (e) => (
          e.preventDefault(),
          r && r({ query: x }),
          null == E || E.tracker.trackSearchSubmit(x, { original_query: x }),
          { query: x }
        ),
        className: 'cio-form',
...
function g(t) {
  var n;
  const { item: o, index: i, sectionIdentifier: c, children: l } = t,
    { getItemProps: a } = r(m);
  let s;
  return (
    (s = (function (e) {
    ...
    e.createElement(
      'li',
      { ...a({ item: o, index: i, sectionIdentifier: c }), className: 'cio-item' },
      l || s
    )
  );
}
function v(e) {
  const { section: t, children: n = f } = e;
  return n({ section: t });
}
const f = ({ section: t }) => {
  var n;
  ...
  return e.createElement(
    'li',
    { className: `${o} cio-section`, role: 'none' },
    e.createElement(
      'h5',
      ...
      null === (n = null == t ? void 0 : t.data) || void 0 === n
        ...
        : n.map((n, o) => {
            ...
            return e.createElement(g, {
              ...
              key: `${null == t ? void 0 : t.identifier}_${
                null === (i = null == n ? void 0 : n.data) || void 0 === i ? void 0 : i.id
              }`
            });
          })
    )
...
function h(t) {
  const { children: n = x } = t,
    { sections: o, isOpen: i, getMenuProps: c, getItemProps: l } = r(m),
    a =
      o &&
      o.some((e) => {
        var t;
...
const x = ({ sections: t }) =>
  e.createElement(
    e.Fragment,
    null,
    null == t ? void 0 : t.map((t) => e.createElement(v, { section: t, key: t.identifier }))
  );
function y(e) {
  const { children: t = b } = e,
    { getFormProps: n, getInputProps: o, getLabelProps: i, setQuery: c } = r(m);
  return t({ getFormProps: n, getInputProps: o, getLabelProps: i, setQuery: c });
}
const b = ({ getFormProps: t, getInputProps: n, getLabelProps: o, setQuery: i }) => {
  const r = n();
  return e.createElement(
    'form',
    { ...t() },
    e.createElement('label', { ...o(), hidden: !0 }, 'Search'),
    e.createElement('input', { ...r }),
    e.createElement(
      'button',
      {
...
function E(t) {
  const { children: n } = t;
  return n
    ? e.createElement(p, { ...t }, n)
    : e.createElement(
        'div',
        null,
        e.createElement(p, { ...t }, e.createElement(y, null), e.createElement(h, null))
      );
}
export {
  h as AutocompleteResults,
  E as CioAutocomplete,
  y as SearchInput,
  g as SectionItem,
  v as SectionItemsList,
  d as useCioAutocomplete
};
