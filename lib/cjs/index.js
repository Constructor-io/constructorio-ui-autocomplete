...
const l = ({
    ...
    n.useCombobox({
      id: 'cio-autocomplete-' + c++,
      items: t,
      itemToString: (e) => (null == e ? void 0 : e.value) || '',
      ...
      onSelectedItemChange({ selectedItem: t }) {
        ...
        t &&
          ...
          (null == t ? void 0 : t.value) &&
            (o && o({ item: t, originalQuery: r }),
            (null === (n = null == t ? void 0 : t.data) || void 0 === n ? void 0 : n.url) ||
              null == i ||
              i.tracker.trackSearchSubmit(t.value, { original_query: r }),
            null == i ||
  ...
  a = (t, n, o) => {
    ...
    return (
      o &&
        (l.resultsPerSection = o.reduce((e, t) => {
          var n;
          return {
            ...e,
            [t.identifier]:
      ...
      e.useEffect(() => {
        c
          ? null == n ||
            n.autocomplete.getAutocompleteResults(c, l).then((e) => {
              const t = {};
  ...
  s = [
    { identifier: 'Search Suggestions', type: 'autocomplete' },
    { identifier: 'Products', type: 'autocomplete' }
  ],
  u = (t) => {
    const n = 'What can we help you find today?',
      ...
      x = (({ apiKey: t, cioJsClient: n }) => {
        const [o, i] = e.useState(n);
        return (
          e.useEffect(() => {
            if (t && !n) {
              const e = new r.default({ apiKey: t, sendTrackingEvents: !0 });
              i(e);
            } else n && i(n);
          }, [t, n]),
          o
        );
      })({ apiKey: u, cioJsClient: d }),
      y = !v.length && f;
    let b = y ? f : p;
    p &&
      !Array.isArray(p) &&
      ...
      f &&
        ...
        (b = []));
    const E = null == b ? void 0 : b.filter((e) => 'autocomplete' === e.type || !e.type),
      S = null == b ? void 0 : b.filter((e) => 'recommendations' === e.type),
      C = a(v, x, E),
      w = ((t, n) => {
              ...
              (async () => {
                const e = await Promise.all(
                    n.map(({ identifier: e, parameters: n }) =>
                      t.recommendations.getRecommendations(e, n)
                    )
                  ),
                  o = {};
                e.forEach(({ response: e }) => {
                  ...
                  (null == t ? void 0 : t.id) &&
                    (o[t.id] = null == n ? void 0 : n.map((e) => ({ ...e, section: t.id })));
                }),
                  i(o);
              })();
          }, [t]),
    ...
    null == I ||
      I.forEach((e) => {
        (null == e ? void 0 : e.data) && k.push(...e.data);
      });
    const N = l({
        setQuery: g,
        onChange: i,
      ...
      { isOpen: A, getMenuProps: M, getLabelProps: F, openMenu: q, closeMenu: Q } = N;
    return {
      query: v,
      sections: I,
      isOpen: A,
      ...
      getItemProps: ({ item: e, index: t = 0, sectionIdentifier: n = 'Products' }) => {
        const o = (({ activeSections: e, sectionIdentifier: t }) => {
          let n = 0;
          return (
            t &&
              e.find((e) => {
        ...
        })({ activeSections: I, sectionIdentifier: n });
        return {
          ...N.getItemProps({ item: e, index: t + o }),
          className: 'cio-item',
          'data-testid': `cio-item-${n.replace(' ', '')}`
        };
      },
      getInputProps: () => ({
        ...N.getInputProps(),
        ...
        onFocus: () => {
          ...
          t.onFocus && t.onFocus(),
            y && !1 !== c && N.openMenu(),
            null === (e = null == x ? void 0 : x.tracker) || void 0 === e || e.trackInputFocus();
        },
        className: 'cio-input',
      ...
      getFormProps: () => ({
        onSubmit: (e) => (
          e.preventDefault(),
          o && o({ query: v }),
          null == x || x.tracker.trackSearchSubmit(v, { original_query: v }),
          { query: v }
        ),
        className: 'cio-form',
...
function p(t) {
  var n;
  const { item: o, index: r, sectionIdentifier: c, children: l } = t,
    { getItemProps: a } = e.useContext(d);
  let s;
  return (
    (s = (function (e) {
    ...
    i.default.createElement(
      'li',
      { ...a({ item: o, index: r, sectionIdentifier: c }), className: 'cio-item' },
      l || s
    )
  );
}
function f(e) {
  const { section: t, children: n = v } = e;
  return n({ section: t });
}
const v = ({ section: e }) => {
  var t;
  ...
  return i.default.createElement(
    'li',
    { className: `${n} cio-section`, role: 'none' },
    i.default.createElement(
      'h5',
      { className: 'cio-sectionName', 'aria-hidden': !0 },
      ...
      null === (t = null == e ? void 0 : e.data) || void 0 === t
        ...
        : t.map((t, n) => {
            ...
            return i.default.createElement(p, {
              ...
              key: `${null == e ? void 0 : e.identifier}_${
                null === (o = null == t ? void 0 : t.data) || void 0 === o ? void 0 : o.id
              }`
            });
          })
    )
...
function g(t) {
  const { children: n = h } = t,
    { sections: o, isOpen: r, getMenuProps: c, getItemProps: l } = e.useContext(d),
    a =
      o &&
      o.some((e) => {
        var t;
  ...
  let s;
  s = r && a ? ('function' == typeof n ? n({ sections: o, getItemProps: l }) : n) : null;
  const u = { ...c() };
  return i.default.createElement('ul', { ...u }, s);
}
!(function (e, t) {
  void 0 === t && (t = {});
  var n = t.insertAt;
...
const h = ({ sections: e }) =>
  i.default.createElement(
    i.default.Fragment,
    null,
    null == e ? void 0 : e.map((e) => i.default.createElement(f, { section: e, key: e.identifier }))
  );
function x(t) {
  const { children: n = y } = t,
    { getFormProps: o, getInputProps: i, getLabelProps: r, setQuery: c } = e.useContext(d);
  return n({ getFormProps: o, getInputProps: i, getLabelProps: r, setQuery: c });
}
const y = ({ getFormProps: e, getInputProps: t, getLabelProps: n, setQuery: o }) => {
  const r = t();
  return i.default.createElement(
    'form',
    { ...e() },
    i.default.createElement('label', { ...n(), hidden: !0 }, 'Search'),
    i.default.createElement('input', { ...r }),
    i.default.createElement(
      'button',
      {
        ...
        onClick: () => {
          var e;
          o(''),
            r.id && (null === (e = document.getElementById(r.id)) || void 0 === e || e.focus());
        },
        type: 'button',
...
(exports.AutocompleteResults = g),
  (exports.CioAutocomplete = function (e) {
    const { children: t } = e;
    return t
      ? i.default.createElement(m, { ...e }, t)
      : i.default.createElement(
          'div',
          null,
          i.default.createElement(
  ...
  (exports.SearchInput = x),
  (exports.SectionItem = p),
  (exports.SectionItemsList = f),
  (exports.useCioAutocomplete = u);
