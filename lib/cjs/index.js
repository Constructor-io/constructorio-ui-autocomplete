...
const c = ({
  ...
  r = (t, n, o) => {
    ...
    return (
      o &&
        (r.resultsPerSection = o.reduce((e, t) => {
          var n;
          return {
            ...e,
            [t.identifier]:
      ...
      e.useEffect(() => {
        c
          ? null == n ||
            n.autocomplete.getAutocompleteResults(c, r).then((e) => {
              const t = {};
  ...
  s = (t) => {
    const n = 'What can we help you find today?',
      ...
      y = !g.length && f,
      b = y ? f : p,
      E = null == b ? void 0 : b.filter((e) => 'autocomplete' === e.type || !e.type),
    ...
    return {
      ...
      sections: I,
      isOpen: M,
      getMenuProps: () => ({ ...A(), className: 'cio-results', 'data-testid': 'cio-results' }),
      getLabelProps: F,
      openMenu: q,
      closeMenu: _,
      ...
      getFormProps: () => ({
        ...
        onSubmit: (e) => (
          e.preventDefault(),
          o && o({ query: g }),
          null == x || x.tracker.trackSearchSubmit(g, { original_query: g }),
          { query: g }
        ),
        className: 'cio-form',
...
function m(t) {
  var n;
  const { item: o, index: l, sectionIdentifier: c, children: r } = t,
    { getItemProps: a } = e.useContext(u);
  let s;
  return (
    (s = (function (e) {
    ...
    i.default.createElement(
      'li',
      { ...a({ item: o, index: l, sectionIdentifier: c }), className: 'cio-item' },
      r || s
    )
  );
}
...
function g(t) {
  const { children: n = v } = t,
    { sections: o, isOpen: l, getMenuProps: c, getItemProps: r } = e.useContext(u),
    a =
      o &&
      o.some((e) => {
        var t;
  ...
  let s;
  s = l && a ? ('function' == typeof n ? n({ sections: o, getItemProps: r }) : n) : null;
  const d = { ...c() };
...
const v = ({ sections: e }) =>
  i.default.createElement(
    i.default.Fragment,
    null,
    null == e ? void 0 : e.map((e) => i.default.createElement(p, { section: e, key: e.identifier }))
  );
function h(t) {
...
const x = ({ getFormProps: e, getInputProps: t, getLabelProps: n, setQuery: o }) => {
  const l = t();
  return i.default.createElement(
    'form',
    { ...e() },
...
(exports.AutocompleteResults = g),
  ...
  (exports.SearchInput = h),
  (exports.SectionItem = m),
  (exports.SectionItemsList = p),
  (exports.useCioAutocomplete = s);
